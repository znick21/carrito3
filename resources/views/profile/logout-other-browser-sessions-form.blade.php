<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <!-- Modal de Confirmación para Cerrar Sesión en Otras Dispositivos -->
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-danger-button class="ml-2" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{ __('Cerrar Sesión') }}
                </x-jet-danger-button>
            </x-slot>
        </x-jet-dialog-modal>
